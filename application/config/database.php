...
$db['onlinetest']['username'] = 'u491932328_crud';
$db['onlinetest']['password'] = 'hRd47uKw77FBo_aS-7UK';
$db['onlinetest']['database'] = 'u491932328_crud';
$db['onlinetest']['dbdriver'] = 'mysqli';
$db['onlinetest']['dbprefix'] = '';
$db['onlinetest']['pconnect'] = TRUE;
$db['onlinetest']['db_debug'] = TRUE;
