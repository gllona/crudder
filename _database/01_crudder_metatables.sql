...
(23, 0, 2, 'id_table', 'id_table', '', '', '', '', '', '', 'INT', 0, 'trim|required|is_numeric', 1, 0, 0, 3, 0, 0, 'Integer. The ID of the table that includes this field in its structure. Tables IDs are managed in table "crudder_table"'),
